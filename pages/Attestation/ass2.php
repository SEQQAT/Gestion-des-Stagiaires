            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../Taches/general.php" class="nav-link " >
                  ...
                  <li class="nav-item">
                    <a href="../Attestation/ass2.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                ...
                <?php 
                   ...
                   if($result)
                   {
                       ...
                       ?>
                          ...
                          <button class="btn btn-lock" type="button"><a onclick='return confirm("Afficher le profile ???")' href="profile_ass2.php?id_affecter=<?=$row['id_affecter']?>"  class="btn btn-success"><span class="fa fa-download"></span></a></button>
